...
function Necrosis_Localization_Dialog_Fr()
	...
	NECROSIS_MESSAGE = {
		...
		["Help"] = {
			"/necro recall -- Centre Necrosis and tous les boutons au centre de l'�cran",
			"/necro sm -- Remplace les messages de pierre d'\195\162me et d'invocation par des versions courtes sp�ciales raid"
		},
		["EquipMessage"] = "Equipe ",
